            ...
            <div class="profile-container" onclick="redirige()">
                ...
                <div class="profile_input">
                    <form class="formulario_1 is-active" data-state="#perfil" action="procesar.php" method="POST" enctype="multipart/form-data">
                        ...
                        <form class="formulario_2" id="perfilForm" style="display:none;" data-state="#carta_presentacion" action="procesar.php" method="POST" enctype="multipart/form-data">
                         <label for="descripcion">Carta de Presentación:</label>
                         <div  class="input_profile_2"> 
                            <input type="text" placeholder ="Nombres" value="<?php echo $user['nombre_1']." ";  echo $user['apellido_1']; ?>" name="Nombres" id="Nombres">
                            <input type="text" placeholder="profesión" value="<?php echo $carta_presentacion['profesion']; ?>"name="nombre_empresa" id="nombre_empresa">
                         </div>
                        ...
                        <input type="text" name="instagram" placeholder="Link instagram"  value ="<?php echo $carta_presentacion['instagram']; ?>" id="instagram">
                        ...
                        <input type="text" name="numero_cel" placeholder="Numero Celular" value="<?php echo $user['celular']; ?>" id="numero_cel">
                        <input type="text" name="email" placeholder="Email" value="<?php echo $user['correo_electronico']; ?>" id="email">
                        <div class="input_profile">
                            <input type="submit" value="Actualizar Datos">
                        </div>
                    </form>
